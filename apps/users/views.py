...
class UploadImageView(LoginRequiredMixin,View):
    ...
    """
    def post(self,request):
        image_form=UploadImageForm(request.POST,request.FILES,instance=request.user)#通过form和model  modelform简单化
...
class MyMessageView(LoginRequiredMixin,View):
    ...
    def get(self,request):
        ...
        p = Paginator(all_messages,5, request=request)#每页显示一条数据
